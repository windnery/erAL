...
from config.source_config import (
    ALL_SOURCE_KEYS, POSITIVE_SRC, NEGATIVE_SRC,
    EMOTION_POS_SRC1, EMOTION_POS_SRC2, EMOTION_NEG_SRC1, EMOTION_NEG_SRC2,
    RATIONALITY_POS_SRC, RATIONALITY_NEG_SRC,
    EMOTION_POS_SRC1_WEIGHT, EMOTION_POS_SRC2_WEIGHT,
    EMOTION_NEG_SRC1_WEIGHT, EMOTION_NEG_SRC2_WEIGHT,
    RATIONALITY_POS_SRC_WEIGHT, RATIONALITY_NEG_SRC_WEIGHT,
)
from config.base_config import MAX_EMOTION, MAX_RATIONALITY, MIN_EMOTION, MIN_RATIONALITY
