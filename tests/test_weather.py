...
class WeatherSystemTests(unittest.TestCase):
    ...
    def test_refresh_changes_weather_key(self) -> None:
        ...
        self.assertIn(self.world.weather_key, {"clear", "cloudy", "rain", "heavy_rain", "snow", "storm", "fog"})
