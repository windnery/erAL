...
- [x] 仓库中同时存在 `starter_*`、`enterprise`、`laffey` 角色包
- [x] 应用启动后能加载企业与拉菲
- [x] 企业与拉菲的 `BASE/PALAM/ABL/TALENT/CFLAG/marks` 初值可从运行时对象中读取到
- [x] 现有 starter 角色加载与现有测试语义不退化
- [x] 本批没有引入 AI 地文、纸娃娃地文、编辑器等超范围实现
- [x] 角色初值已迁移到按数值族拆分的独立 TOML 文件
- [x] 存档/读档链路对企业与拉菲初值可正确保存和恢复

**验收状态：全部通过（2026-04-12）**
