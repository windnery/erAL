...
| 维度 | 状态 |
|------|------|
| 测试 | 326 全通过，含 L4 经济循环烟测 |
| 内容校验 | 通过 |
| 角色包 | 3 (企业/拉菲/标枪) |
| 指令数 | 54 + recovery 类扩展（含 sleep/nap/bathe） |
| 地点数 | 10 |
| 关系阶段 | 5（已升级多条件门槛：affection/trust/intimacy） |
| 通用口上 | 仅 3 条 `_any` |
| 港区设施 | 3 (官舍/食堂/约会点，各4级) |
| CLI UI | 主界面 PALAM 等级条 + tab 切换 + 能力显示 5tab 已充实 |
