...
| # | 任务 | 里程碑 | 类型 | Est | 状态 |
|---|------|--------|------|-----|------|
| 1 | 关系成长公式调参说明 | L3 | docs | 60m | 🔵 todo |
| 2 | 14 天可玩烟测（基础版） | L3 | test | 60m | 🟢 todo |
| 3 | 14 天可玩烟测（全链路版） | L3 | test | 90m | ⚪ todo |
| 4 | 数值平衡与调参说明 | L4 | docs | 60m | ⚪ todo |
| 5 | 誓约层指令+事件+对话 | L5 | content | 120m | 📋 规划中 |
| 6 | 贝尔法斯特角色包 | L5 | content | 120m | 📋 规划中 |
| 7 | 通用口上兜底（54指令） | L5 | content | 90m | 📋 规划中 |

**执行顺序**：先完成 L3 调参 → 两轮烟测 → L4 数值优化 → L5 内容扩充
...
| **L1** ✅ | 完成 | 100% | 核心玩法已闭合（7天可玩+2条剧线） |
| **L2** ✅ | 完成 | 100% | 语义可读层已接入 |
| **L3** 🔄 | **进行中** | **80%** | ⬜ 调参说明 ⬜ 基础烟测 ⬜ 全链路烟测 |
| **L4** 🟡 | 规划中 | 60%** | 经济循环 ✅ / 数值平衡 ⬜ |
| **L5** 📋 | 筹划中 | 0% | 誓约+新角色+通用口上 |

*标注：✅成功 🔄进行中 🟡部分完成 📋筹划中 ⬜待启动*

---

## 🔴 当前活跃任务（主线 E：L3 数值闭环与体力系统稳定化）

> 把已接入的体力/气力骨架、关系成长公式与新阈值体系跑成"可平衡、可回归、可继续扩内容"的稳定版本。
